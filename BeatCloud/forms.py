...
class CreateVidForm(FlaskForm):
    ...
    # showTitle is not title_control! it will disable itself if this is applied to its classes.
    ...
    # video_quality is 'title_control' class as it may affect size of text when changing title dimensions
    video_quality = SelectField('Video Quality', choices=[('720', '720p'), ('1080', '1080p')], render_kw={'class':'visually-hidden title_control', "id":"quality_select"}) 
